...
\if1\blind
{
  ...
  \bigskip
  \begin{center}
    {\LARGE\bf The Impact of Sampling Variability on Estimated Combinations of Distributional \\ \bigskip Forecasts}
\end{center}
  \medskip
} \fi
